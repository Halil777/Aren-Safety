...
import { useBranches, useCreateBranch, useUpdateBranch, useDeleteBranch } from "@/features/branches/api";
...
export default function BranchesPage() {
  ...
  return (
    <PageContainer $isDark={isDark}>
      <PageHeader>
        <HeaderLeft>
          <PageTitle $isDark={isDark}>Branches</PageTitle>
          <PageSubtitle $isDark={isDark}>
            Manage branches for your organization
          </PageSubtitle>
        </HeaderLeft>
        <Space size={12}>
          <StyledButton
